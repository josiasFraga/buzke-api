...
class RankingsController extends AppController
{
    ...
    public function index()
    {
        ...
        $categoriaCondition = $categoriaId ? "AND tj.torneio_categoria_id = {$categoriaId}" : "";
    ...
    -- Avanços de Fase (Avanço de Fase = 5 pontos)
    COUNT(DISTINCT CASE 
        WHEN tj.fase > 1 THEN tj.id 
    END) AS avancos_de_fase,

    -- Vitórias em Jogos (Jogo Ganho = 2 pontos)
    COUNT(DISTINCT CASE 
    ...
    SUM(
        CASE 
            ...
            WHEN tj.fase > 1 THEN 5                                        -- Avanço de fase
            WHEN tj.vencedor = ti.id THEN 2                                -- Jogo ganho
            ELSE 0
        END
    ) AS total_pontos
